from numpy import * # NumPy (multidimensional arrays, linear algebra, ...)
from scipy import ndimage # SciPy (signal and image processing library)
...
def H_from_ransac(fp,tp,model,maxiter=1000,match_theshold=10):
    ...
    #H la model parameters which best fit the data (or nil if no good model is found)
